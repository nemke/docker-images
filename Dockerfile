...
yum -y --enablerepo=remi-php72 --enablerepo=remi install php-fpm php-mbstring php-soap gd-last php-gd ImageMagick php-xml php-mysqlnd php-process php-cli php-pear php-bcmath php-mcrypt php-intl php-pecl-zip php-opcache && \
yum clean all && \
